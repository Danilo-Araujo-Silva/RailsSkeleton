...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { breadcrumb: @permission.breadcrumb, description: @permission.description, name: @permission.name, parent_id: @permission.parent_id } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { breadcrumb: @permission.breadcrumb, description: @permission.description, name: @permission.name, parent_id: @permission.parent_id } }
